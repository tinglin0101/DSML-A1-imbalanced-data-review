...
def smote_keel_data(filepath, output_filepath):
    """
    讀取 KEEL 格式資料，對特徵進行 SMOTE，再輸出為相同格式
    """
    # 讀取原始檔案
...
def main(base_path=r".\dataset", dataset_name="yeast1-5-fold"):
    ...
    # print(f"開始針對 {input_dir} 中的訓練集執行 SMOTE 過採樣...")
    ...
    for filename in os.listdir(input_dir):
        ...
        if filename.endswith('tra.dat'): 
            ...
            try:
                smote_keel_data(input_path, output_path)
